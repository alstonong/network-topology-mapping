...
## To Do
1. Merge JSONs in n8n
2. Try to create Mermaid code in n8n out of the JSONs
...
| 9 | Deploy Report | `mkdir -p /path/to/desired/folder && cat << 'EOF' > /path/to/desired/folder/topology.html\n{{ $json.generated_html }}\nEOF` |
